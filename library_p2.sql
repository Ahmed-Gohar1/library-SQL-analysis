...
(
	    ...
	    position VARCHAR(30),
	    salary DECIMAL(10,2),
	    branch_id VARCHAR(25) -- Fk branch_id
);
...
(
	    ...
	    issued_member_id VARCHAR(30), -- Fk member_id
	    issued_book_name VARCHAR(80),
	    issued_date DATE,
	    issued_book_isbn VARCHAR(50), -- Fk isbn 
	    issued_emp_id VARCHAR(25) -- Fk emp_id
);

ALTER TABLE issued_status
ALTER COLUMN issued_id TYPE  VARCHAR(35);
...
(
	    ...
	    issued_id VARCHAR(30), -- Fk issued_id
	    return_book_name VARCHAR(80),
	    return_date DATE, 
	    return_book_isbn VARCHAR(50) -- Fk isbn
);
